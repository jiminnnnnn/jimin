...
## 👋 intro
대학교 컴퓨터공학부 소프트웨어를 전공하였으며
4학년 1년동안 벤처 아카데미 수업을 들으며 
...
#### 1. 기존 버달 서비스 어플은 복잡한 UI/UX로 특정 사용자들에게 접근성이 떨어진다.
#### 2. 생성형 AI를 도입하여 음성인식을 통해 접근성 향상
...
### 나의 특징에 맞는 이름(별명)을 생성해주는 서비스를 만들어보자!
#### 1. 기존의 랜덤 이름 생성기 말고 나의 특징을 통해 이름(별명)을 만들 수는 없을까?
...
### 재난상황 대비 카카오톡 챗봇
	...
	스킬:
		...
		프롬프트 엔지니어링: 효과적인 프롬프트 작성 및 테스트
  		서버 개발 및 운영: Goorm IDE를 활용한 서버 설계 및 구축
### 재난 시 문자가 오는 것에 그치지 말고 더 자세한 대응법을 알려줄 수 있는 서비스가 있으면 좋겠다.
#### 1. 기존에는 재난이 발생하면 문자만 오고 후속 조치는 미흡하다. 
#### 2. 유사 서비스 분석
#### 3. 챗봇 제작
#### 4. Open API를 활용해 챗gpt 연동
